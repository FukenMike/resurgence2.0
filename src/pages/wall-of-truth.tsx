...
const posts = [
  {
    title:
      'How the System Buried My Fatherhood: The Truth They Tried to Seal Away',
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto text-white">
      ...
      <p className="mb-8 text-lg text-steam-text">
        Real voices. Unfiltered pain. Stories the system tried to silence — but
        we’re bringing them into the light.
      </p>
