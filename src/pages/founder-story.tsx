  ...
  return (
    <section className="px-6 py-12 max-w-4xl mx-auto text-white">
      ...
      <p className="mb-4">
        ...
        *Why are we treated like second-rate citizens?*  
        *Why don’t we even fit on the forms?*
      </p>
      ...
      <p className="mb-4">
        ...
        And yeah—sometimes it really does feel like it’s *designed* that way.  
