  ...
  return (
    <div className="flex flex-col gap-8">
      <section className="space-y-3">
        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-ocean">Who we serve</p>
        <h1 className="text-4xl font-semibold text-ink">{whoWeServeCopy.headline}</h1>
        <p className="max-w-3xl text-lg text-muted">{whoWeServeCopy.body}</p>
      </section>
