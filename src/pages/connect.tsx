...
export default function Connect() {
  return (
    <section className="px-6 py-12 max-w-4xl mx-auto text-white">
      ...
      <p className="mb-4">
        The Father’s Alliance is still rising—still becoming. This isn’t some
        polished nonprofit with a switchboard and a team of reps. This is one
        man building something real from the ground up—and inviting others to
        rise with me.
      </p>

      <p className="mb-4">
        If you’ve lived through what I’ve lived through—or if you care about
        what’s happening to families in this country—reach out. Whether you want
        to share your story, volunteer, collaborate, or just say{' '}
        <em>“I see you”</em>, your voice matters.
      </p>
      ...
      <p className="mb-4 leading-relaxed">
        ...
        <a
          href="/wall-of-truth"
          className="text-steam-copper underline hover:text-steam-brass"
        >
          Wall of Truth
        </a>
        ...
        <span className="text-sm italic">
          {' '}
          (yes, no “e” — TikTok username limit!)
        </span>
        .
      </p>

      <p className="mt-8 text-lg font-semibold text-steam-brass">
        You don’t have to be perfect to show up. You just have to care. Let’s
