...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-16 text-steam-text bg-steam-bg min-h-screen font-body">
      <h1 className="text-3xl font-heading font-bold mb-6 text-steam-copper">
        Privacy Policy
      </h1>
      <p className="mb-4">Effective Date: June 7, 2025</p>

      <p className="mb-4">
        The Father’s Alliance (“we,” “us,” or “our”) respects your privacy. This
        policy outlines what personal information we collect, how we use it, and
        how we protect it.
      </p>

      <h2 className="text-xl font-semibold mt-8 mb-2 text-steam-brass">
      ...
      <p className="mb-4">
        We take reasonable steps to protect your data using encrypted services,
        limited access, and secure platforms.
      </p>
      ...
      <p className="mb-4">
        ...
        <a
          ...
          className="text-steam-copper underline"
        >
      ...
      <p>
        We may update this policy over time. When we do, we’ll update the
        effective date above. Please check back periodically.
      </p>
    </div>
  )
}
