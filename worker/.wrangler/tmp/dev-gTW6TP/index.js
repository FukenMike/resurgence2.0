...
var src_default = {
  async fetch(req, env) {
    ...
    async function handleAdminNote(env2, req2) {
      const url2 = new URL(req2.url);
      const sid = getCookie(req2, "tfa_session");
      ...
      const body = await req2.json().catch(() => null);
    ...
    __name(handleAdminNote, "handleAdminNote");
...
// .wrangler/tmp/bundle-8COMjd/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-8COMjd/middleware-loader.entry.ts
